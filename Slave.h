...
//#define Cmd_brk       0
#define en_cross        60 //положение перекидки устроило после I7=666 => начинаем обнуление расходомера
#define dis_cross       61 //не верное положение перекидки после установки I7=666 
#define en_start        62 //расх-р подготовлен можно начинать считать первый проход
#define en_start_pause  63 //первый проход пройден ждем пока перекидка дойдет до второго концевика
#define en_start_back   64 //перекидка в правильном положении можно начинать считать обратный проход
#define finished        65 //измерение закончено запуск останова счета //после останова счета
