...
#define dis_cross       661 //не верное положение перекидки после установки I7=666 
...
#define finished        665 //измерение закончено запуск останова счета //после останова счета установится в 0
    ...
    #define en_time         880 //включен режим измерения времени пролета перекидки туда обратно
    ...
    //YN -//\\-
        ...
        #define dis_cmpr       991 //не верное положение di_1
