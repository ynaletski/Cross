...
&s_frd.vol_x,        // 37 F1074 Объем при движении перекидки на весы (интерполированный)
&s_frd.mass_x,       // 38 F1076 Масса при движении перекидки на весы (интерполированая)

&frd_T1,             // 39 F1078 Время перед первым концевиком, (мс - на весы и сличение, мкс - измерение времени) 
&frd_Tx,             // 40 F1080 Время первого концевика, (мс - на весы и сличение, мкс - измерение времени)
&frd_T2,             // 41 F1082 Время после первого концевика, (мс - на весы и сличение, мкс - измерение времени)

&s_back.vol_x,       // 42 F1084 Объем при движении перекидки в бак (интерполированный)
&s_back.mass_x,      // 43 F1086 Масса при движении перекидки в бак (интерполированая)

&back_T1,             // 44 F1088 Время перед вторым концевиком, (мс - на весы и сличение, мкс - измерение времени)
&back_Tx,             // 45 F1090 Время второго концевика, (мс - на весы и сличение, мкс - измерение времени)
&back_T2,             // 46 F1092 Время после второго концевика, (мс - на весы и сличение, мкс - измерение времени)
